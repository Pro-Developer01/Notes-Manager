        ...
        <div className='container d-flex-column justify-content-center'>
            <div className="btn-group d-flex justify-content-center my-4" style={{ width: '100%' }}>
                <div>
                    ...
                    <button className="btn btn-outline-primary mx-3" onClick={() => { setCreateNte( true); setAllNote(false) }}><AddIcon style={{
                        color: 'green', fontSize: '23px',
                        marginTop: '-4px'
                    }} />CreateNote</button>
                    <button className="btn btn-outline-primary mx-3" onClick={() => { setAllNote(true); setCreateNte(false) }} >All Notes</button>
                </div>
            </div>
            <hr />
